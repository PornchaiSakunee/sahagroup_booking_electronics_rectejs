...
const getStepContent = (step, handleNext) => {
  switch (step) {
    case 0:
      return <StepCart handleNext={handleNext} products={dataItem} />
    case 1:
...
const CheckoutWizard = () => {
  ...
  return (
    <Card>
      <CardHeader title='ใบจองอุปกร์ไฟฟ้า' className='pbe-4' />
      <CardContent>
        <StepperWrapper>
          <Stepper
