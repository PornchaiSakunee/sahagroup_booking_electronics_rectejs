...
const UserDropdown = () => {
  ...
  const [Profile, setProfile] = useState(decoded)
    ...
    <UncontrolledDropdown tag="li" className="dropdown-user nav-item">
      ...
      >
        <div className="user-nav d-sm-flex d-none">
          <span className="user-name fw-bold">{Profile.userData.username}</span>
          <span className="user-status">{Profile.userData.cus_company}</span>
        </div>
        <Avatar
          img={defaultAvatar}
          imgHeight="40"
